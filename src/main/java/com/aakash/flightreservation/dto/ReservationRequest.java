package com.aakash.flightreservation.dto;

public class ReservationRequest {

	private Long flightId;
	private String passenegerFirstName;
	...
	public String toString() {
		return "ReservationRequest [flightId=" + flightId + ", passenegerFirstName=" + passenegerFirstName
